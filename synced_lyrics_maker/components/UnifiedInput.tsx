        ...
        <div className="flex flex-col gap-4 h-full">
            ...
            <Card className={cn(
                ...
                <div className="relative flex-1 group">
                    <Textarea
                        ref={textareaRef}
                        className="absolute inset-0 w-full h-full resize-none rounded-none border-0 bg-transparent p-6 font-mono text-sm leading-relaxed focus-visible:ring-0 placeholder:text-slate-600"
